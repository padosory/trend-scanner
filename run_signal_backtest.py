...
from backtest.signal_engine import SignalBacktestEngine
...
def main() -> None:
    ...
    engine = SignalBacktestEngine(tickers, args.start, args.end, entry_fn, exit_fn)
    trades = engine.run()
    ...
    out_path = RESULTS_DIR / f"signal_{args.strategy}{suffix}_{args.start}_{args.end}.csv"
